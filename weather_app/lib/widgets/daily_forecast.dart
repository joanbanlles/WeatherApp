...
class DailyForecastWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final blueShade200 = Colors.blue.shade200;
  ...
  Widget _buildDailyItem(DailyForecast day) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: isToday ? Border.all(color: Colors.white70, width: 1.2) : null,
      ),
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(child: WeatherIcon(iconUrl: day.conditionIcon, size: 32)),
            Expanded(
              child: Text(
                '${day.maxTempC.round()}°',
